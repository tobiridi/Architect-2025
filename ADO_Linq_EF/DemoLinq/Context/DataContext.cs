    ...
    public sealed class DataContext
    {
        ...
        public DataContext()
        {
            ...
            this.Courses.AddRange(new Course[] {
                new Course(){ Course_ID = "EG2120", Course_Name = "Financial Management", Course_Ects = 4.0F, Professor_ID = 3},
                new Course(){ Course_ID = "EG1020", Course_Name = "Marketing management", Course_Ects = 3.5F, Professor_ID = 2},
                new Course(){ Course_ID = "EG2210", Course_Name = "Derivatives", Course_Ects = 3.0F, Professor_ID = 3},
                new Course(){ Course_ID = "EG3010", Course_Name = "Marketing engineering", Course_Ects = 4.0F, Professor_ID = 1},
                new Course(){ Course_ID = "EG2110", Course_Name = "Supply chain management et e-business", Course_Ects = 2.5F, Professor_ID = 5}
            });
